...
#define USBD_MANUFACTURER_STRING	 (uint8_t *)"FLYFIRE"
#define USBD_PRODUCT_HS_STRING		 (uint8_t *)"Flyfire parachute USB HS"
#define USBD_PRODUCT_FS_STRING		 (uint8_t *)"Flyfire parachute USB FS"
