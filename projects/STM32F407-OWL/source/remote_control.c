...
const uint8_t rc_reply_usb[10] = {0xAA, 0x59, 0x00, 0x05, MAIN_STA_USB_STORAGE, 0x00, 0x03, 0x00, 0xEB, 0xE3};
const uint8_t rc_reply_noapp[10] = {0xAA, 0x59, 0x00, 0x05, MAIN_STA_BL_NOAPP, 0x00, 0x03, 0x00, 0xEB, 0xE4};
const uint8_t rc_reply_upgrading[10] = {0xAA, 0x59, 0x00, 0x05, MAIN_STA_BL_UPGRADING, 0x00, 0x03, 0x00, 0xEB, 0xE5};
//const uint8_t rc_reply_upgrading[10] = {0xAA, 0x59, 0x00, 0x05, 0x04, 0x00, 0x03, 0x00, 0xEB, 0xF7};
