...
const uint8_t rc_reply_usb[10] = {0xAA, 0x59, 0x00, 0x05, 0x00, 0x00, MAIN_STA_USB_STORAGE, 0x00, 0xEB, 0xE0};
const uint8_t rc_reply_noapp[10] = {0xAA, 0x59, 0x00, 0x05, 0x00, 0x00, MAIN_STA_BL_NOAPP, 0x00, 0xEB, 0xE1};
const uint8_t rc_reply_upgrading[10] = {0xAA, 0x59, 0x00, 0x05, 0x00, 0x00, MAIN_STA_BL_UPGRADING, 0x00, 0xEB, 0xE2};
